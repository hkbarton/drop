...
var Step = function(task, next){
  var contextProduct = task && task.context ? 
...
DeployFiles.prototype.backupFile = function(filePath, backupFolder, cb){
...
DeployFiles.prototype.deployFile = function(srcPath, destPath, backupFolder){
